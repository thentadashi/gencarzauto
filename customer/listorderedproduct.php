...
?>
						...
						<div class="row">
							<?php echo $_SESSION['ordernumber']; ?>
								<?php 
									...
									?>
								<?php
									foreach ( $res as $row) echo $row->countitem; ?> 
		...
		?>
					...
					<h5>DEAR Ma'am/Sir ,</h5>
					<h5>Your order is on its way, The Delivery Period is 2-7 days! As you have ordered via Cash on Delivery, please have the exact amount of cash for our deliverer.	</h5>
					<hr/>
				...
				<?php
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		echo '<td ><img src="'.web_root.'admin/products/'. $result->IMAGES.'" width="60px" height="60px" title="'.$result->OWNERNAME.'"/></td>';
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right" style="">Sub total Price : &#8369 <?php echo number_format($subtot,2);?></p>
