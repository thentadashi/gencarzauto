        ...
        <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="hidden" name="PROID" value="<?php  echo $result->PROID; ?>">
                ...
                <p><b><?php echo   $result->OWNERNAME;?></b></p>
                <!-- <h3>Project Details</h3> -->
                <div style="font-size: 15px;">
                    <p>Category: <?php echo $result->CATEGORIES; ?></p>
                    <p>Price: &#8369 <?php echo $result->PROPRICE; ?></p>
                    <p>Discount: <?php echo $result->PRODISCOUNT; ?> % </p> 
                    <p>Discounted Price: &#8369 <?php echo $result->PRODISPRICE; ?> </p> 
                </div>
        ...
        <div class="col-md-6">
             ...
             <div class="form-group">
                ...
                <input type="hidden" class="form-control " name="PROID" id="PROID" value="<?php echo $result->PROID; ?>">
                  ...
                  <input type="input" class="form-control disper" name="PRODISCOUNT" id="PRODISCOUNT" value="<?php echo $result->PRODISCOUNT; ?>">
          ...
          <div class="col-md-6">
             <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text"  class="form-control" name="PRODISPRICE" id="PRODISPRICE" placeHolder="<?php echo $result->PRODISPRICE; ?>" readonly="true">
                </div>
                <!-- /.input group -->
              </div>
