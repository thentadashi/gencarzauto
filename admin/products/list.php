<?php
		...
		<div class="row">
			...
			<div class="col-lg-6">
            <h4 class="page-header"><b>Indicators Guide: <a class="btn btn-outline"><i class="fa fa-circle" title="Stock is normal" style="color:green"></i>  Stock is normal</a><a class="btn btn-outline"><i class="fa fa-circle" title="Stock is low" style="color:orange"></i> Stock is low</a><a class="btn btn-outline"><i class="fa fa-circle" title="Out of stock" style="color:red"></i> Out of stock</a></b></h4>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
